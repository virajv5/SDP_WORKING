...
//            object.put("payment_status", status_glob);
    ...
    public void onPaymentSuccess(String s) {
        ...
        // Create an instance of Order_GetSet with the order details
        Order_GetSet order = new Order_GetSet(
                "", // Order ID (leave blank as it will be automatically generated by Firebase)
                s, // Payment reference ID received from Razorpay
                pref.getStringvalue(SHARED_USER_ID), // User ID
                pref.getStringvalue(SHARED_USER_name), // User name
                "", // Product list (you may need to update this with the actual product list)
                String.valueOf(Constant.pass_payment_value), // Total amount
                dateTime, // Order date
                "success", // Payment status (assuming it's successful)
                "0" // Admin approval status (assuming it's pending)
        );
        ...
        ordersRef.push().setValue(order)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        // Navigate to the next activity or perform any other actions as needed
                        // For example:
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(User_CheckOutActivity.this, "Failed to place order: " + e.getMessage(), Toast.LENGTH_SHORT).show();
